...
$(document).ready(() => {
    ...
    modelViewerComparison1.cameraOrbit = "-36deg 92deg 0.80m"; // Exemple: vue de dessus, à 1.5m
    ...
    modelViewerComparison2.cameraOrbit = "-36deg 92deg 0.80m"; // Exemple: vue diagonale
